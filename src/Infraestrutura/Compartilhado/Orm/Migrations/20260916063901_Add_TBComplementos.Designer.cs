...
namespace DeliveryApp.Infraestrutura.Compartilhado.Orm.Migrations
{
    ...
    [Migration("20260916063901_Add_TBComplementos")]
    partial class Add_TBComplementos
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DeliveryApp.Dominio.Modulos.Cardapio.Produto", b =>
                {
                    ...
                    b.HasOne("DeliveryApp.Dominio.Modulos.Cardapio.Categoria", "Categoria")
                        .WithMany()
                        .HasForeignKey("CategoriaId", "EstabelecimentoId")
                        .HasPrincipalKey("Id", "EstabelecimentoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
